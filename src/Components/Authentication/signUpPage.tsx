...
const SignUpPage:React.FC<SignUpPageProps> = ({onClose}) => {
  ...
  return (
    ...
    <Input type='email' placeholder="Enter Title" value={email} onChange={(e)=>{setEmail(e.target.value)}}/>
    <FormLabel>Enter Password</FormLabel>
    <Input type='password' placeholder="Enter Title" value={password} onChange={(e)=>setPassword(e.target.value)}/>
